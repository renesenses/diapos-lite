...
<div id="Box">
	<form id="ListBox" name="ListBox">
	</form>
	<form id="AddBox" 
		<input type="text" name="NoBox" value="NoBox">
		<input type="submit" name="btnValiderBox" id="boutonValider" VALUE="Valider" onclick="fonctionValider()"/>
	</form>
</div>
<div id="Event">
</div>
